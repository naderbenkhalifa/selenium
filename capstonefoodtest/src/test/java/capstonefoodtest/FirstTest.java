...
public class FirstTest {
    ...
    public void setUp() {
    	...
    	System.setProperty("webdriver.chrome.driver","C:\\WeDevZone\\Dev\\Tools\\selenuim-test\\chromedriver_win32\\chromedriver.exe");
    	wd  =   new ChromeDriver();
    ...
    public void contextLoads() {
      ...
      wd.findElement(By.name(LOGIN_EMAIL)).sendKeys("nader.benkhalifa@gmail.com");
        wd.findElement(By.name(LOGIN_PWD)).sendKeys("aaaa1111");
